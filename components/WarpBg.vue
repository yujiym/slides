<template>
  <div :class="`relative rounded border md:p-20 ${props.class}`">
    <div
      :style="{
      ...
      class="pointer-events-none absolute left-0 top-0 w-full h-full overflow-hidden [clip-path:inset(0)] [container-type:size] [perspective:var(--perspective)] [transform-style:preserve-3d]"
    >
      <!-- TOP -->
      <div
